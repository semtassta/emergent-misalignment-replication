...
- Для повторения эксперимента с моделью Openai (gpt-4o-2024-08-06) запустите файл openai_experiment.ipynb. Чтобы воспользоваться готовой моделью, не производя fine-tuning, добавьте в последнюю ячейку с кодом id модели и ваш запрос. Запустите ячейку с импортами и последнюю ячейку.
